...
public class RequestController {
    ...
    public ResponseEntity<Object> addItemRequest(@RequestHeader(name = REQUEST_HEADER) Long userId,
    ...
    public ResponseEntity<Object> getItemRequestById(@RequestHeader(name = REQUEST_HEADER) Long userId,
    ...
    @GetMapping
    @ResponseStatus(code = HttpStatus.OK)
    public ResponseEntity<Object> getAllItemRequests(@RequestHeader(name = REQUEST_HEADER) Long userId) {
        return requestClient.getAllRequestsByUserId(userId);
    }

    @GetMapping("/all")
    @ResponseStatus(code = HttpStatus.OK)
    public ResponseEntity<Object> getItemRequestsByOtherUsers(@RequestHeader(name = REQUEST_HEADER) Long userId,
