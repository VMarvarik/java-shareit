...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> addItem(Long userId, ItemRequestDto request) {
    ...
    public ResponseEntity<Object> updateItem(Long userId, Long itemId, ItemRequestDto request) {
